...
('office_address', '123 Example Street, Hamilton 3200'),
('service_1_name', '主日崇拜 (Main Chapel)'),
('service_1_time', '每周日 下午 2:00'),
('service_1_location', '456 Sample Road, Hamilton 3200'),
('service_2_name', ''),
('service_2_time', ''),
('service_2_location', ''),
('smtp_host', ''),
...
('admin', '系统', '管理员', '021 555 0100', 'admin@example.com', '$2b$12$VnnvK2V9Onm3XypDfSWiseo.hp0FymbzDowkfkZ4spmqDw5/JX5cS', 1, 'Active'),
('coord_chen', '陈', '执事', '021 000 0002', 'coordinator@example.com', '$2b$12$VnnvK2V9Onm3XypDfSWiseo.hp0FymbzDowkfkZ4spmqDw5/JX5cS', 2, 'Active'),
('op_lin', '林', '弟兄', '021 000 0003', 'operator@example.com', '$2b$12$VnnvK2V9Onm3XypDfSWiseo.hp0FymbzDowkfkZ4spmqDw5/JX5cS', 3, 'Active'),
('member_wang', '王', '姐妹', '021 000 0004', 'member@example.com', '$2b$12$VnnvK2V9Onm3XypDfSWiseo.hp0FymbzDowkfkZ4spmqDw5/JX5cS', 4, 'Active'),
('member_li', '李', '弟兄', '021 000 0005', 'member2@example.com', '$2b$12$VnnvK2V9Onm3XypDfSWiseo.hp0FymbzDowkfkZ4spmqDw5/JX5cS', 4, 'Active');
...
('乐龄团契', 'fellowship', '为尊贵的年长弟兄姐妹而设，活动涵盖社交聚会、户外活动、文化艺术活动等，并提供关怀与支持。', '每周五 上午 10:00', '456 Sample Road, Hamilton', '021 123 4567', 2, 'public', 'active'),
('成人团契', 'fellowship', '成人团契提供查经、祷告会、社交聚会以及参与教会和社会活动的机会，帮助成年信徒在信仰中找到归属感。', '每周六 晚上 7:30', '123 Example Street, Hamilton', '021 000 0002', 2, 'public', 'active'),
('青年团契', 'fellowship', '尊主为圣，传扬福音。活动包括查经、聚餐、全年圣经阅读挑战等，支持青年人的属灵与个人成长。', '每周五 晚上 7:30', '123 Example Street, Hamilton', '021 000 0004', 4, 'public', 'active'),
('少年团契', 'fellowship', '透过福音影响青少年，使他们成为基督耶稣的门徒。', '每周六 下午 2:00', '456 Sample Road, Hamilton', '021 000 0005', 5, 'public', 'active'),
('大学生查经小组', 'fellowship', '由牧师指导的查经小组，定期阅读、讨论和分享圣经，帮助大学生建立属灵支持与友谊。', '每周四 晚上 7:00', '123 Example Street, Hamilton', '021 000 0002', 2, 'public', 'active'),
('祷告会', 'ministry', '集体祷告、唱诗、读经和属灵分享，一同寻求上帝的同在。', '每周三 晚上 7:30', '123 Example Street, Hamilton', '021 555 0100', 1, 'public', 'active'),
('英语角', 'ministry', '免费英语课程，由本地老师教学，分为初级、中级和高级班。', '每周二 晚上 7:00', '456 Sample Road, Hamilton', '021 555 0100', 1, 'public', 'active'),
('儿童主日学', 'ministry', '以故事、游戏、歌曲和手工艺教导孩子基督教信仰、圣经故事和道德。', '主日崇拜时段', '456 Sample Road, Hamilton', '021 555 0100', 1, 'public', 'active'),
('少年主日学', 'ministry', '在周日教会聚会时间内进行，帮助青少年建立信仰基础并与同龄人一起成长。', '主日崇拜时段', '456 Sample Road, Hamilton', '021 555 0100', 1, 'public', 'active'),
('招待事工', 'ministry', '主日崇拜及特别聚会的接待与签到服事。', '主日崇拜时段', '两处崇拜地点', '021 555 0100', 1, 'private', 'active');
...
(NULL, '主日崇拜 (Main Chapel)', '主日崇拜：唱诗、祷告、证道。欢迎所有弟兄姐妹与朋友参加。', '456 Sample Road, Hamilton 3200', DATE_ADD(CURDATE(), INTERVAL (7 - WEEKDAY(CURDATE())) % 7 + 2 DAY) + INTERVAL 14 HOUR, DATE_ADD(CURDATE(), INTERVAL (7 - WEEKDAY(CURDATE())) % 7 + 2 DAY) + INTERVAL 16 HOUR, 'worship', 1, 1),
(6, '周三祷告会', '一同为教会、城市与世界的需要祷告，分享感恩与代祷事项。', '123 Example Street, Hamilton', DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 19 HOUR, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 21 HOUR, 'prayer', 1, 1),
(7, '英语角 (初级班)', '免费英语课程，由本地老师教学。欢迎新朋友参加！', '456 Sample Road, Hamilton 3200', DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 19 HOUR, DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 21 HOUR, 'ministry', 1, 1),
(3, '青年团契聚会', '查经、分享与团契时光。欢迎青年朋友加入！', '123 Example Street, Hamilton', DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 19 HOUR, DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 21 HOUR, 'fellowship', 1, 1),
(2, '成人团契聚会', '查经、祷告与彼此分享。', '123 Example Street, Hamilton', DATE_ADD(CURDATE(), INTERVAL 6 DAY) + INTERVAL 19 HOUR, DATE_ADD(CURDATE(), INTERVAL 6 DAY) + INTERVAL 21 HOUR, 'fellowship', 1, 1),
(1, '乐龄团契聚会', '社交聚会与关怀时光，欢迎年长弟兄姐妹参加。', '456 Sample Road, Hamilton', DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 10 HOUR, DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 12 HOUR, 'fellowship', 1, 1),
(NULL, '福音布道会（预告）', '年度福音布道会，欢迎邀请亲友参加。详细安排请留意教会通知。', '456 Sample Road, Hamilton 3200', DATE_ADD(CURDATE(), INTERVAL 30 DAY) + INTERVAL 14 HOUR, DATE_ADD(CURDATE(), INTERVAL 30 DAY) + INTERVAL 17 HOUR, 'special', 1, 1);
